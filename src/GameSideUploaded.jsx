...
export default function GameSideUploaded({ Lang, setSelectedImg1, setSelectedImg2, setSelectedImg3, setSelectedImg4, setSelectedImg5, setSelectedImg6,
    setSelectedImg7, setSelectedImg8, SelectedImg1, SelectedImg2, SelectedImg3, SelectedImg4, SelectedImg5, SelectedImg6, SelectedImg7, SelectedImg8, setGameUploadedStarted, SetQuery}) {
    ...
    let [CardGalery,setCardGalery] = useState([
        {id : 1, src: SelectedImg1, title : '1', Fliped : false},
        {id : 2, src: SelectedImg2, title : '2', Fliped : false},
        {id : 3, src: SelectedImg3, title : '3', Fliped : false},
        {id : 4, src: SelectedImg4, title : '4', Fliped : false},
        {id : 5, src: SelectedImg5, title : '5', Fliped : false},
        {id : 6, src: SelectedImg6, title : '6', Fliped : false},
        {id : 7, src: SelectedImg7, title : '7', Fliped : false},
        {id : 8, src: SelectedImg8, title : '8', Fliped : false},
        {id : 9, src: SelectedImg1, title : '1', Fliped : false},
        {id : 10, src: SelectedImg2, title : '2', Fliped : false},
        {id : 11, src: SelectedImg3, title : '3', Fliped : false},
        {id : 12, src: SelectedImg4, title : '4', Fliped : false},
        {id : 13, src: SelectedImg5, title : '5', Fliped : false},
        {id : 14, src: SelectedImg6, title : '6', Fliped : false},
        {id : 15, src: SelectedImg7, title : '7', Fliped : false},
        {id : 16, src: SelectedImg8, title : '8', Fliped : false}
    ])
  ...
  return (
            ...
            <div className='Wrap'>
                    ...
                    <div key={Cards.id} className={Cards.Fliped ? "card__inner is-flipped" : "card__inner"}>
                        ...
                        <div key={Cards.id+16} className="card__face card__face--back">
                            <div key={Cards.id+16} className="card__content">
                                <img key={Cards.id+16} src={Cards.src} alt="Image" className='ImageCard'/>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <img className='GoBackToHomeButton' src="./Home.png" onClick={handleBack}/>
